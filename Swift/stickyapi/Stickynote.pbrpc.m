...
#pragma mark StreamHello(stream SayHelloRequest) returns (stream SayHelloResponse)

- (void)streamHelloWithRequestsWriter:(GRXWriter *)requestWriter eventHandler:(void(^)(BOOL done, SayHelloResponse *_Nullable response, NSError *_Nullable error))eventHandler{
  [[self RPCToStreamHelloWithRequestsWriter:requestWriter eventHandler:eventHandler] start];
}
// Returns a not-yet-started RPC object.
- (GRPCProtoCall *)RPCToStreamHelloWithRequestsWriter:(GRXWriter *)requestWriter eventHandler:(void(^)(BOOL done, SayHelloResponse *_Nullable response, NSError *_Nullable error))eventHandler{
  return [self RPCToMethod:@"StreamHello"
            requestsWriter:requestWriter
             responseClass:[SayHelloResponse class]
        responsesWriteable:[GRXWriteable writeableWithEventHandler:eventHandler]];
}
- (GRPCStreamingProtoCall *)streamHelloWithResponseHandler:(id<GRPCProtoResponseHandler>)handler callOptions:(GRPCCallOptions *_Nullable)callOptions {
  return [self RPCToMethod:@"StreamHello"
           responseHandler:handler
               callOptions:callOptions
             responseClass:[SayHelloResponse class]];
